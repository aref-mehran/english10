...
شناسه افزوده برنامه ریزی و تألیف: سیّد بهنام علوی مقدّم، رضا خی رآبادی، مهرک رحیمی و حسین داوری )اعضای گروه تألیف( -
...
9 شابك: 0 3090  05  964  78
ISBN: 0  3090  05  964  978
پیش تر به زبان )خارجی( احتیاج نبود.
امروز احتیاج است. باید زبا نهای
...
به منظور تدریس در پایۀ دوازدهم تحصیلی، تألیف Vision سوّمین جلد از مجموعه کتاب های
...
توجّه به جنبه های عاطفی و نقش آنها در فرایند آموزش زبان
...
نموده و با مطالعۀ کتاب راهنمای معلم آن کتاب ها و مشاهدۀ فیلم های آموزشی دبیران با
با اصول تدریس بر اساس رویکرد ارتباطی فعّال و خودباورانه آشنایی » برفراز آسمان « عنوان
...
را با توجه و دقت هر چه تمام تر مطالعه نمایند. به این شکل بسیاری از Vision کتاب های
پرسش ها و ابهامات احتمالی دربارۀ شیوۀ تدریس کتاب، نحوۀ زما نبندی و فعّالیت های جنبی
برطرف می شود. مجددًا تأکید م یکنیم تدریس درست و مؤثر این کتاب بدون مطالعۀ کتاب
...
انگلیسی آگاه گردند و به این منظور پیشنهاد می شود با استفاده از ظرفیت جلسات ویژۀ تعامل
والدین با مدرسه ،دربارۀ این تحولات، اطلاع رسانی لازم انجام گیرد.
لازم به یادآوری است که مجموعۀ غنی و کاملی از منابع مورد نیاز همکاران از جمله فایل های
تمامی اجزای بستۀ آموزشی، مجموعۀ دستورالعمل ها و آئین نامه های مربوطه و جدیدترین
اخبار و اطلاعات مورد نیاز همکاران گرامی از طریق وبگاه گروه زبان های خارجی دفتر تألیف
کتاب های درسی به نشانی زیر قابل دستیابی است که بازدید مرتب از این پایگاه نیز اکیدًا توصیه
می شود. یادآوری می گردد دبیران گرامی و دانش آموزان محترم می توانند فایل صوتی )کتاب
گویا( را از وبگاه زیر تهیه نمایند.
...
نکتۀ پایانی این که طبق ضوابط مصوّب وزارت آموزش و پرورش، در صورت نیاز، تنها استفاده
از کتاب ها و منابع کمک آموزشی تأئید شده توسط طرح سامان بخشی کتاب های کمک
...
بالندگی آیند هسازان میهن عزیزمان را فراهم می آوردند، مؤلفان، این تلاش ارزشمند را ارج نهاده
...
Map of
Vision 3
Lesson 1: Sense of Appreciation (15- 41)
Get Ready
Conversation
New Words
& Expressions
...
Reading Strategy
(Highlighting)
Lesson 3: Renewable Energy (71-99)
Get Ready
Conversation
New Words
& Expressions
...
1
18
C. Write appropriate nouns after the following adjectives. Then check ( )
...
a polite a cruel
some lazy two kind
a loving some careful
L E S S O N
1
19
Sara: Excuse me, who is that man in the picture?
Nurse: Oh, don’t you know him? Have you ever heard of Dr.
Mohammad Gharib?
Sara: I guess I have only seen his name in my English book,
but I’m not sure about it.
Nurse: Dr. Gharib was a famous physician.
Sara: Oh,… can you tell me a little about his life?
Nurse: Dr. Gharib was born in Tehran in 1288. After receiving
...
Nurse: Dr. Gharib was also a generous man. He spared no pains
...
Nurse: He was known as a distinguished university professor,
...
Nurse: By the way, it might be interesting to know that your
...
Hamid sits on the sofa and
watches TV all the time.
Dad really shouted at me when I
didn’t do my homework.
My grandfather feeds the pigeons in
...
Ferdowsi was born in a village
near Toos.
L E S S O N
1
23
...
diary: a book in which you record your thoughts or feelings or what
...
Question Starter Possible Answer
L E S S O N
1
25
L E S S O N
...
A. Read the passage. Generate at least five questions with the question
...
1
28
B. With a classmate, check the answers by looking for the collocations in
...
4
5
A. Without looking back at the Conversation, make collocations by
...
time. He was born sometime between the years 1310 and 1337 A.D1. in
...
Doctors have made a new medicine to
cure cancer.
...
A new medicine has been made by doctors to
cure cancer.
Active Passive
L E S S O N
1
...
F. Pair up and talk about the things that happened in the past without
mentioning the doer.
Example: The window was broken.
Many products (are developed/developed) each year. Light bulb, camera,
airplane, and telephone (were invented/invented) by scientists and
inventors. Laptops, smart phones, and tablets (were made/made) by lots
of work. But not all products (are developed/developed) by hard work.
Some inventions (were created/ are created) by accident or scientists’
mistakes. Penicillin, for instance, (was discovered/were discovered)
quite accidentally when Alexander Fleming (was working/ was worked)
on bacteria. Microwave oven also (was invented/invented) during a
scientist’s experiment on energy. More interestingly, some tools and
technologies (are not made/do not make) by scientists at all. Some like
dishwashers and computer games (were made/made) by ordinary people
like workers, housewives and school students.
1
2
3
4
...
Tag questions
B. Go to Part ‘Grammar’ of your Workbook and do C.
L E S S O N
1
32
A. We use ‘tag questions’ for two reasons: eliciting agreement (confirming
...
and one verb. Such a sentence is called a simple sentence.
A sentence with more than one subject, more than one verb and a
connecting word such as and, or, but or so is called a compound
sentence.
...
2) Behnam’s family went to the zoo last week, they did
not enjoy it.
3) Susan has a pink dress, she never wears it.
4) Kate saw Sofia, she didn’t speak to her.
5) My English class is really enjoyable, I have a lot of
homework.
L E S S O N
1
36
...
1) My mother doesn’t like fast food, she doesn’t eat any.
2) I go out tonight, I take a rest.
3) We can eat our lunch at the restaurant, we can have it
at home.
4) That dictionary is expensive, I can’t buy it.
5) This dress is not comfortable, she rarely wears it.
1- Use a comma before and, or, but and so when you combine two
sentences.
...
1
39
E. Write five real compound sentences about yourself, your family or
friends.
F. Go back to the Reading. Find three simple and three compound
...
mm1 which needs to be read with a magnifying glass.
...
I. A monolingual dictionary II. A bilingual dictionary
French
#NAME?
Dictionary
Spanish
...
2
46
C. Check what types of information you cannot find in an English
dictionary.
...
3. Searching for the word ‘ ’ in
English
4. Looking up the adjective of
‘destroy’
5. Looking up the Persian meaning of
...
2
47
Majid: Excuse me Mr. Iranmehr, I wonder if you could help
me.
Mr. Iranmehr: Sure. How can I help you?
Majid: I’d like some information about a good English
dictionary.
Mr. Iranmehr: Oh, well. Have you ever used a dictionary?
Majid: Actually, I haven’t. But I’ve heard that using a good
...
Mr. Iranmehr: It is designed for foreign students. It also helps them
...
48
Answer the following questions orally.
1. What type of dictionary does Mr. Iranmehr
recommend?
2. What factors do you consider when you
want to choose a dictionary?
3. What type of dictionary do you often use?
Mr. Iranmehr: No, in fact dictionaries have different types, levels,
and sizes.
Majid: What type do you suggest?
Mr. Iranmehr: I suppose a monolingual dictionary is more suitable
for you, because you can find word information in
English.
Majid: And what about levels?
Mr. Iranmehr: Well, there are usually three levels: elementary,
intermediate and advanced. For you as a high school
student, an elementary one is OK.
Majid: Do I need a small size one?
Mr. Iranmehr: Yes, a pocket dictionary. You can carry it wherever you
go.
Majid: Oh, it’s very good. And hmm…, is it expensive?
Mr. Iranmehr: No, such dictionaries are not expensive. By the way,
you can use a free online dictionary, too. And also
there are some free dictionaries for PCs and apps for
smart phones.
Majid: Thanks, that’s a good idea, but I’d like to use a pocket
dictionary!
L E S S O N
2
49
A. Look, Read and Practice.
Try to avoid foods that contain a
lot of fat.
C is the symbol for carbon.
I circled the dictionary entry for the
word ‘purpose’.
L E S S O N
2
50
Mehran couldn’t figure out what the
...
From the letters X and Y, we can get two combinations:
XY and YX.
...
If you know how to study more effectively, you’ll be
able to learn more.
...
I did not read the introduction and jumped into the
next part.
B. Read and Practice.
...
1. Choose the Right Dictionary. There are many different types of
...
2. Read the Introduction. The best way to learn how to use your
...
3. Learn the Abbreviations. Different types of abbreviations are
...
2
53
4. Learn the Guide to Pronunciation. If you immediately jump into
...
1)
2)
A. Read the following paragraph and highlight the most important
information.
Sharks are not all the same. In fact, there are nearly 400
different kinds. Most sharks never attack people. Only a
special group of sharks can be dangerous. They kill an average
of forty people every year. Let’s compare sharks with snakes.
Snakes kill about 60,000 people every year. And let’s not
forget that people kill 25,000,000 sharks every year.
B. Now go back to the ‘Reading’. It claims that you can be familiar
with useful information to use a dictionary more effectively. Highlight
parts of the passage that support this claim.
C. Read the ‘Reading’. Generate questions with the following question
starters and then answer them.
L E S S O N
2
55
...
can be enough to allow you to read on. For example, in this
sentence:
“We provide you with some helpful information on how to use
a dictionary more effectively”
you can get an idea of the meaning of the word effectively by
recognizing that it is related to the word effect.
In this technique which is also known as word attack, looking
...
2
56
B. Attack these words to figure out their meanings. Try to write down
...
international:
unchangeable:
A. Look at the following sentences. Write down at least one other word
...
B. Read the following example sentences.
A. Read the following text.
The first Persian dictionary which is still published was compiled
more than 900 years ago. Loghat-e Fors was made by Asadi Tusi
who was a famous poet in the 5th century. The list of entries has
been arranged according to the final letters of the words. There are
example sentences which were taken from poetry. The dictionary
has synonyms and explanations that were used by young poets. This
dictionary has been used widely by the poets who lived after Asadi
Tusi. Many words have been added to the first dictionary which Asadi
compiled. The dictionary has been published several times and is a
valuable treasure of Persian language.
The man plays golf.
He lives at No. 10.
...
2
59
D. Read the following paragraph and fill in the blanks with ‘who’ or
‘which’.
E. Complete the following sentences. Then compare them with your
friend.
Example: Rudaki who lived in the 4th century is a famous Persian
poet.
1. Ostrich is a bird
2. Our English teacher
3. The notebook
Mr. Sanders is a doctor lives in a city. He works in
a village is near the city. Each morning he goes to
the village and comes back home in the evening. Mr. Sanders
usually catches the morning train enters the
station at 7:30. The train he catches is not very
...
newspapers he borrows from the stand in the
...
A. Look at the examples below. Choose the one which has the right shape
for a paragraph.
L E S S O N
2
65
...
It is called the ،topic sentence’ because it tells readers what they are
going to read about.
...
2. Hydropower or power is produced as a result of falling or
running water.
3. Solar energy or the energy that comes from can be used to
heat, cool, and light our homes and schools.
4. Wind turbines convert the kinetic energy in the into
mechanical power.
a. wind b. water c. sunshine d. plants
L E S S O N
3
74
C. This picture shows six ways you can save energy. Place the letter
...
Emad: Wind turbines?
Father: Yes, wind turbines are used to produce electricity from
wind power.
Emad: I know electricity can be produced from water and
sunlight. How might it be generated from wind?
Father: Well, a wind turbine works the opposite of a fan. Instead
of using electricity to make wind, a turbine uses wind
to make electricity. It is a type of clean energy.
Emad: These wind turbines remind me of what I read about
...
3. What types of clean energy can you find
in your city or village?
Emad: Yes, they are natural air cooling systems and can be
...
77
A. Look, Read and Practice.
The main sources of renewable Iran is rich in oil resources.
energy are wind, water and sun.
...
3
78
The new light bulbs consume
less electricity.
My uncle often sits in the balcony,
...
To have a healthier lifestyle, people need to do certain
things. First they should check their general health.
Measuring blood pressure and heartbeat is the most
important thing to do. They also need to check their
family health history. In this way, they understand if
anyone in the family has had a special illness.
L E S S O N
3
81
L E S S O N
...
A. Use the information in the ‘Reading’ to complete the notes. Then
compare your notes with your classmates’ notes.
B. Go back to the ‘Reading’ and try to take notes on the basis of the
guidelines:
C. Read the ‘Reading’. Find what these words refer to.
L E S S O N
3
...
start work early if you
want to succeed.
English Proverb Meaning Persian Proverb
از تو حرکت
از خدا برکت
سحر خیز باش
تا کامروا باشی
...
3
84
A. Match the following proverbs with their meanings and then write
...
8. Out of sight, out
of mind
a) When two people cooperate with
each other, they come up with better
ideas.
b) When you get money quickly, like
by winning it, it’s easy to spend it or
lose it quickly as well.
c) When there are too many people
trying to lead and give their opinions,
it’s confusing and leads to bad
results. Jobs and projects should
have one or two strong leaders.
d) You soon forget people or things
that are no longer visible or present.
e) People like to spend time with
others who are similar to them.
f) Just saying that you’ll do
something doesn’t mean much.
Actually doing it is harder and more
meaningful.
g) You have to practice a skill a lot to
become good at it.
h) Your plans might not work out, so
don’t start thinking about what you’ll
do after you succeed. Wait until
you’ve already succeeded, and then
...
B. Read the following example sentences.
A. Read the following text.
Did you know that the things nobody needs can be used to produce
electricity, heat or fuel? Changing waste to energy can be considered
one of the most helpful ways to save the resources of the earth. Because
garbage can be changed directly into a liquid fuel, it can be used in cars,
trucks, buses and airplanes. To do that, garbage should be collected and
taken to a landfill by workers. People may be paid for voluntary garbage
delivery as well. It is important to know that not all types of waste can
be used to produce fuel. Some materials may give off harmful gases in
the process. Therefore, people should be informed of this danger and
warned about the possible harms.
The principal should call the
parents.
The cook may make a fish
salad for dinner.
People must obey the traffic
rules.
The parents should be called (by
the principal).
A fish salad may be made for
dinner (by the cook).
...
E. Read the following sentences and use passive voice with the given
verbs in the parentheses.
1. Something (should/do) about global warming,
or some types of animals will die out.
2. The bill (must/pay) before leaving the restaurant.
3. Some dangerous gases (may/produce) when
garbage is burned.
4. Wind (can/change) into electricity.
F. Pair up and talk about the things that can/may/should/must be done
...
A. Read the following example sentences.
Past perfect tense
B. Go to part ‘Grammar’ of your Workbook and do D.
Joe had studied Chinese
She had never seen a bear
Everything in the garden was brown
They gave me some money back
I knew I had seen that man somewhere
The woman told me that she had worked in Isfahan
...
before.
before.
my grandparents had already gone home.
...
3
89
A. We use the ‘past perfect tense’ to talk about an event that happened
...
Yeah, it was all fun. Before we played volleyball, we had taken
some photographs.
Great! Did you do anything in the afternoon?
Oh, something interesting! After we had eaten lunch, we flew
our kites. That was fantastic because we had made the kites
ourselves!
...
travel to Mashhad borrow a book spend money
catch cold go home leave Tehran
climb Damavand apply for a job pay a check
sing a song go abroad play futsal
Conversation 2
L E S S O N
3
91
A. Read the following paragraphs.Cross out any sentences that do not
...
a load of 1200 pounds1. They eat 300 pounds of food a day. An elephant
baby can weigh 200 pounds at birth. Elephants can live up to 70 years.
1. 1 pound = 454 grams
L E S S O N
3
93
C. Unscramble the following sentences. Then write them in correct
...
3
94
D. Below are sentences from a paragraph in the wrong order. Decide
...
3
95
E. Now you are going to write a paragraph about ‘Learning a New
...
3
97
G. Look at the following picture and then write a paragraph to describe
it.
Iran
Tehran
Turkey
...
Authors:
2021
سازمان پژوهش و برنامه ریزی آموزشی جهت ایفای نقش خطیر خود در اجرای سند تحول بنیادین در آموزش و پرورش و
برنامه درسی ملی جمهوری اسلامی ایران، مشارکت معلمان را به عنوان یک سیاست اجرایی مهم دنبال می کند. برای تحقق
این امر در اقدامی نوآورانه سامانه تعاملی بر خط اعتبارسنجی کتاب های درسی راه اندازی شد تا با دریافت نظرات معلمان
...
آموزشی، دبیرخانۀ راهبری دروس و مدیریت محترم پروژه آقای محسن باهو نقش سازنده ای را بر عهده داشتند. ضمن ارج
نهادن به تلاش تمامی این همکاران، اسامی دبیران و هنرآموزانی که تلاش مضاعفی را در این زمینه داشته و با ارائۀ نظرات
خود سازمان را در بهبود محتوای این کتاب یاری کرده اند به شرح زیر اعلام می شود.
...
2 فرنوش طاهریان سمنان 27 رضا طاهریان خراسان رضوی
...
9 عمران نوری البرز 34 محمود خالصی اصفهان
